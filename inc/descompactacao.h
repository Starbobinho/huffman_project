 ...
 */
int tamanhoLixoArquivoCompactado(FILE *archive);
/**
 ...
 */
int tamanhoArvoreArquivoCompactado(FILE *archive);
 ...
 * @return int 
 */
int tamanhoExtensaoArqCompactado(FILE *archive);
 ...
 * @param archive 
 * @param extension 
 * @param extension_size 
 */
void recuperarExtensaoArqCompactado(FILE *archive, char extension[], int extension_size);
/**
 ...
 */
Node *montarArvore(FILE *archive,short int *treeSize);
/**
 ...
 */
void escreverBytesOriginais(FILE *fileIn,FILE *fileOut,short int trashSize,unsigned long long int sizeFile,Node *huffTree);
